  ...
  return (
    <section id="a-programacao" ref={sectionRef} className="section8">
      <div className="col-left">
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[0]}ms` } : {}}>
          <h2 className="category-title">Organizar</h2>
          <ul>
        ...
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[1]}ms` } : {}}>
          <h2 className="category-title">Analisar</h2>
          <ul>
        ...
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[2]}ms` } : {}}>
          <h2 className="category-title">Criar</h2>
          <ul>
      ...
      <div className="col-right">
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[3]}ms` } : {}}>
          <h2 className="category-title">Automatizar</h2>
          <ul>
        ...
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[4]}ms` } : {}}>
          <h2 className="category-title">Decidir</h2>
          <ul>
        ...
        <div className={`category ${isVisible ? 'fade-in-up' : 'hidden'}`} style={isVisible ? { animationDelay: `${delays[5]}ms` } : {}}>
          <h2 className="category-title">Gerir</h2>
          <ul>
